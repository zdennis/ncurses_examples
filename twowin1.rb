...
begin
  ...
  window2 = Curses.newwin(20,20,5,10)
  # window2 = Curses.newwin(0, 0, 0, 0) creates a new window the same size window
  # as stdscr which is equal to window1 in this example
  Curses.waddstr(window2, "This is the new window created!\n")
